...
const vi: TranslationKeys = {
  ...
  navTooltip: {
    ...
    indicator: [
      ...
      "Nội dung: So sánh số lượng NG hàng tuần hoặc hàng tháng theo model/công đoạn",
      "Tiêu chí: Gấp 2 lần trở lên so với kỳ trước → Cấp C",
      "Chu kỳ: Tuần (T2~CN) / Tháng (ngày 1~cuối tháng) có thể chọn",
    ],
    indicatorStatus: [
      "Đỏ: 200%+ so với kỳ trước (Cấp C)",
      "Tím: Lỗi mới (trước 0 → hiện tại phát sinh)",
      "Vàng: 100~199% so với kỳ trước (tăng)",
      "Xanh: Dưới 100% so với kỳ trước (giảm)",
