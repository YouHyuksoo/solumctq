...
const en: TranslationKeys = {
  ...
  navTooltip: {
    ...
    indicator: [
      ...
      "Content: Weekly or monthly NG count comparison by model/process",
      "Criteria: 2x or more vs previous period → Grade C",
      "Cycle: Weekly (Mon-Sun) / Monthly (1st-last day) selectable",
    ],
    indicatorStatus: [
      "Red: 200%+ vs previous period (Grade C)",
      "Purple: New defect (prev 0 → current occurred)",
      "Yellow: 100~199% vs previous period (increase)",
      "Green: Under 100% vs previous period (decrease)",
      "Gray: No defects (0→0)",
    ],
    fpy: [
      "Target: All processes (ICT, Hi-Pot, FT, Burn-In, ATE, IMAGE, SET)",
