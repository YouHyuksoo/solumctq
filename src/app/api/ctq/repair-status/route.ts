  ...
  try {
    ...
    const sql = `
      SELECT TO_CHAR(t.QC_DATE, 'YYYY-MM-DD HH24:MI:SS') AS QC_DATE,
             ...
             NVL(F_GET_BASECODE('WORKSTAGE CODE', t.WORKSTAGE_CODE, 'C', 1), NVL(t.WORKSTAGE_CODE, '-')) AS WORKSTAGE_NAME,
             NVL(F_GET_BASECODE('REPAIR WORKSTAGE CODE', t.REPAIR_WORKSTAGE_CODE, 'C', 1), NVL(t.REPAIR_WORKSTAGE_CODE, '-')) AS REPAIR_WORKSTAGE_NAME,
             ...
             NVL(F_GET_BASECODE('BAD REASON CODE', t.BAD_REASON_CODE, 'C', 1), NVL(t.BAD_REASON_CODE, '-')) AS BAD_REASON_NAME
