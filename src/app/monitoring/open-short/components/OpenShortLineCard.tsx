      ...
      <table className="w-full text-base">
        <thead>
          <tr className="bg-gray-600/50 text-gray-400 text-xs">
            <th className="text-left px-4 py-3">{t("table.component") as string}</th>
            <th className="text-center px-4 py-3 w-20">{t("table.type") as string}</th>
            <th className="text-center px-4 py-3 w-16">{t("table.count") as string}</th>
            <th className="text-right px-4 py-3">{t("table.lastInspect") as string}</th>
          </tr>
        </thead>
        <tbody>
