 ...
 *
 * 초보자 가이드:
 * 1. 모델(ITEM_CODE)별 × 공정별 전전월/전월 PPM 비교 테이블
        ...
        <div className="flex items-center justify-between max-w-[1920px] mx-auto">
          <div className="flex items-center">
            <h1
              ...
              style={{
                backgroundImage:
                  "linear-gradient(to right, #f87171, #facc15, #4ade80, #60a5fa, #a78bfa, #f472b6)",
              }}
            >
          ...
          <div className="flex items-center gap-4">
            ...
            >
              {loading
                ...
                : (t("pages.indicator.regenerateBtn") as string) || "재생성"}
            </button>
            {/* 새로고침 버튼 */}
            <button
              onClick={() => fetchData()}
        ...
        <div className="flex items-center justify-between max-w-[1920px] mx-auto">
          <div className="flex items-center gap-3 text-xs text-gray-400">
            ...
            <span>
              {loading
                ? (t("common.dataLoading") as string)
                : (t("common.statusNormal") as string)}
            </span>
          </div>
          <div className="flex items-center gap-4 text-xs text-gray-500">
            {data && (
              <span>
                ...
                {new Date(data.lastUpdated).toLocaleTimeString(dateLocale)}
              </span>
            )}
          </div>
        </div>
