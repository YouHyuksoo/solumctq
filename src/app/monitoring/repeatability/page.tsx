/**
 * @file src/app/monitoring/repeatability/page.tsx
...
export default function RepeatabilityPage() {
  const [monitorInterval, setMonitorInterval] = usePersistedState("ctq-repeatability-monitor-interval", 30000);
  const [rollingInterval, setRollingInterval] = usePersistedState("ctq-repeatability-rolling-interval", 10000);
  const [rollingEnabled, setRollingEnabled] = usePersistedState("ctq-repeatability-rolling-enabled", true);
